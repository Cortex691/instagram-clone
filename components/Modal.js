...
const Modal = () => {
  ...
  const uploadPost = async () => {
    ...
    // Get the donwload url from fb storage and update to original post with image
    ...
    console.log("New doc has been created", docRef.id);
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full">
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
                    className="w-full object-container cursor-pointer"
